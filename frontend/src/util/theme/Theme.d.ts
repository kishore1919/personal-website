...
interface Theme {
    ...
    readonly portfolioButtonBrightness: 'brightness(0%) invert(1)' | 'brightness(0%) invert(0.2)';
    readonly portfolioButtonBrightnessHover: 'brightness(0%) invert(0.1)' | 'brightness(0%) invert(0.9)';
    readonly contactTickBrightness: 'brightness(0%) invert(0)' | 'brightness(0%) invert(1)';
