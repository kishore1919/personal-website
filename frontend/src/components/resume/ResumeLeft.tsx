...
import { FaGithub, FaInstagram, FaHeadphones, FaDumbbell, FaBook, FaMapMarkerAlt, FaEnvelope, FaPhone } from 'react-icons/fa';
import { TiSocialLinkedin, TiSocialFacebook } from 'react-icons/ti';
import { KEY, SECONDARY } from '../../util/theme/colorTheme';

const ResumeLeft = () => {

    const resumePath = (light: boolean) => `asset/files/resume/GervinFungDaXuenResume_UTAR_${light ? 'light' : 'dark'}.pdf`;

    const [isSecondary, setIsSecondary] = useState(localStorage.getItem(KEY) === SECONDARY);

    const downloadResume = () => setIsSecondary(localStorage.getItem(KEY) === SECONDARY);

    return (
        <ResumeLeftContainer>
            <Section>
                <SelfIntro>
                    <div><img src={'asset/images/others/resume.webp'} alt='resume.webp'/></div>
                    <SelfIntroLabel>
                    ...
                    <ResumeDownloadContainer>
                        <ResumeDownloadLink href={resumePath(isSecondary)} onClick={downloadResume}>Download</ResumeDownloadLink>
                    </ResumeDownloadContainer>
                    <PersonalWebsite>
                        <WebsiteLink>https://poolofdeath20.herokuapp.com</WebsiteLink>
                    </PersonalWebsite>
                </SelfIntro>    
                ...
                <div>
                    <ContactInfo>
                        <div><Address/></div>
                        <MediumTextSpan>P.O Box 64 A308, Blok F Jalan Datuk Haji Yassin, Tenom, Sabah</MediumTextSpan>
                    </ContactInfo>
                    <ContactInfo>
                        <div><Email/></div>
                        <MediumTextSpan>gervinfungdaxuen@gmail.com</MediumTextSpan>
                    </ContactInfo>
                    <ContactInfo>
                        <div><Phone/></div>
            ...
            <Section>
                ...
                <SocialLinkDiv>
                    ...
                    <SocialLinkName href='https://github.com/GervinFung'>Gervin Fung</SocialLinkName>
                </SocialLinkDiv>
                <SocialLinkDiv>
                    <Linkedin href='https://www.linkedin.com/in/gervin-fung-387409209'>
                        <LinkedinLogo/>
                    </Linkedin>
                    <SocialLinkName href='https://www.linkedin.com/in/gervin-fung-387409209'>Gervin Fung</SocialLinkName>
                </SocialLinkDiv>
                <SocialLinkDiv>
                    <Facebook href='https://www.facebook.com/GervinFung'>
                        <FacebookLogo/>
                    </Facebook>
                    <SocialLinkName href='https://www.facebook.com/GervinFung'>Gervin Fung</SocialLinkName>
                </SocialLinkDiv>
                <SocialLinkDiv>
                    <Instagram href='https://www.instagram.com/poolofdeath20'>
                        <InstagramLogo/>
                    </Instagram>
                    <SocialLinkName href='https://www.instagram.com/poolofdeath20'>PoolOfDeath20</SocialLinkName>
                </SocialLinkDiv>
            </Section>
    
            <Section>
                <SectionTitle>Profile</SectionTitle>
                <MediumTextParagraph>A Software Engineering Undergraduates seeking a full time job in an organization with a professional work-driven environment where I can utilise and improve my current knowledge and skills, and fulfill the organizational goals along the way.</MediumTextParagraph>
            </Section>
